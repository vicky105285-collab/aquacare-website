...
import { CALL, WHATSAPP } from "./constants";
import type {
  AmcPlanItem,
  BookingStep,
  ContactChannelCard,
...
export const FOOTER_SERVICE_LINKS: FooterServiceLink[] = [
  { label: "RO Water Purifier", href: S },
  { label: "RO Service & Repair", href: S },
  { label: "AMC Plans", href: "#amc" },
  { label: "Solar Water Heater", href: S },
  { label: "Solar Panel Install", href: S },
  { label: "Water Softener", href: S },
  { label: "Fridge Repair", href: S },
  { label: "Washing Machine Repair", href: S },
];
