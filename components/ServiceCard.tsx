...
export function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    <article className="group bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl hover:shadow-blue-500/10 border border-slate-100 hover:border-cyan-200 transition-all duration-300 h-full flex flex-col">
      <div
