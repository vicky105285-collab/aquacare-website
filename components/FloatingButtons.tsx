...
export function FloatingButtons({ callHref, whatsappHref }: FloatingButtonsProps) {
  return (
    <div className="hidden md:block">
      {/* WhatsApp Floating Action (Middle of desktop stack) */}
      <a
        href={whatsappHref}
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-24 right-6 z-40 w-14 h-14 bg-green-500 hover:bg-green-400 rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 hover:scale-110 active:scale-95 transition-all duration-200 group motion-reduce:transition-none"
      ...
      {/* Call Now Button (Bottom of desktop stack) */}
      <a
        href={callHref}
        className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center shadow-2xl shadow-blue-500/40 hover:scale-110 active:scale-95 transition-all duration-200 group motion-reduce:transition-none"
