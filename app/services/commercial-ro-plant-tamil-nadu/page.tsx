...
export const metadata: Metadata = {
  title: `Commercial RO Plant Systems Karur & Tamil Nadu | ${COMPANY_NAME}`,
  description:
    `250 LPH to 5000 LPH Commercial RO Water Plants for schools, hospitals, hostels, offices & hotels in Karur & Tamil Nadu by ${COMPANY_NAME} (Formerly ${FORMER_COMPANY_NAME}).`,
  alternates: {
    canonical: `${SITE_URL}/services/commercial-ro-plant-tamil-nadu`,
  },
  keywords: [
    "Commercial RO Plant Tamil Nadu",
    "Commercial RO Plant Karur",
    "500 LPH Commercial RO",
    "1000 LPH RO Plant Karur",
  ],
};

export default function CommercialROPlantTamilNaduPage() {
  return (
    <article className="min-h-screen bg-slate-50">
      <section className="bg-gradient-to-br from-blue-950 via-slate-900 to-cyan-950 text-white py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto text-center pt-8">
          <div className="inline-flex items-center gap-2 bg-cyan-500/20 border border-cyan-400/30 rounded-full px-4 py-1.5 text-cyan-300 text-xs font-semibold mb-6">
            ...
            <span>Serving Commercial Institutions Since 2014 (Formerly {FORMER_COMPANY_NAME})</span>
          </div>

          <h1 className="text-3xl md:text-5xl font-black mb-6 leading-tight">
            Commercial RO Water Treatment Plants in Tamil Nadu
          </h1>

          <p className="text-base md:text-xl mb-8 leading-relaxed max-w-3xl mx-auto text-cyan-100">
            Provide pure drinking water under 50 PPM TDS for staff, students, and guests. Heavy SS 304 skids, automated sand filters, and reliable after-sales AMC.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            >
              <MessageCircle className="w-5 h-5" /> WhatsApp Commercial Quote
            </a>
          </div>
        </div>
      </section>
      ...
      <CTASection
        ...
        headline="Request Commercial RO Plant Sizing"
        subheadline="Consult with Yuvanthika Aquacare & Solar Care Systems commercial engineers."
